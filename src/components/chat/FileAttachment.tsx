  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        {isDragOver && (
          <div className="absolute inset-0 border-2 border-dashed border-violet-500 rounded-lg bg-violet-900/10 flex items-center justify-center z-10">
        ...
        {files.length > 0 && (
          <div className="flex flex-wrap gap-2 p-2 border-t border-violet-800">
            {files.map((file) => (
              <div
                key={file.id}
                className="relative group bg-black/50 border border-violet-700 rounded-lg p-2 flex items-center gap-2 max-w-xs"
              >
                ...
                <Button
                  ...
                  className="h-6 w-6 p-0 text-gray-400 hover:text-white hover:bg-red-500/20 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <X className="w-3 h-3" />
                </Button>
              </div>
