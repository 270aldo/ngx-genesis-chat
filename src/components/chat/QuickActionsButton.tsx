    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="premium-glow-button relative h-10 px-4 bg-gradient-to-r from-blue-500/20 to-purple-600/20 hover:from-blue-500/30 hover:to-purple-600/30 border border-blue-500/30 text-white shadow-lg hover:shadow-xl transition-all duration-300"
        >
      ...
      <PopoverContent 
        className="w-80 p-4 bg-black/90 backdrop-blur-xl border border-white/10" 
        align="end"
      >
            ...
            {actions.map((action, index) => {
              ...
              return (
                <Button
                  ...
                  className="flex flex-col gap-1.5 h-auto py-3 px-3 text-xs text-white/70 hover:text-white hover:bg-white/10 rounded-xl border border-transparent hover:border-white/10 transition-all duration-200"
                >
